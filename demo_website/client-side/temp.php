...
<body>
    ...
    <section class="cont">
        <div class="inside">
            <div class="title">
                <div><h2>Beginner Workouts</h2></div>
                <div><a href="#"><h2>View All Free Workouts</h2></a></div>
            </div>
            <div class="cardcont">
                <?php
                // Fetch Beginner Workouts
                $sql = "SELECT * FROM workoutplan WHERE planCategoryID = 1"; // Assuming category ID 1 is for beginner workouts
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '
                            <div class="cards">
                                <a href="#">
                                    <div class="upper">
                                        <img src="data:image/jpeg;base64,' . $imageData . '" alt="' . $workoutPlanName . '">
                                    </div>
                                </a>
                                <div class="bottom">
                                    <div class="workout-title">
                                        <h1>' . $workoutPlanName . '</h1>
